...
run_cli_failure("Output temporary file already exists\n" seal-file --in "${plain_file}" --out "${temp_collision_sealed}" --key-hex "${file_key}")
if(EXISTS "${temp_collision_sealed}")
  message(FATAL_ERROR "seal-file created output when temporary output existed")
endif()
...
run_cli_failure("Output temporary file already exists\n" open-file --in "${sealed_file}" --out "${temp_collision_opened}" --key-hex "${file_key}")
if(EXISTS "${temp_collision_opened}")
  message(FATAL_ERROR "open-file created output when temporary output existed")
endif()
...
run_cli_failure("Output temporary file already exists\n" seal-file-password --in "${plain_file}" --out "${password_temp_collision_sealed}" --password-file "${password_file}")
if(EXISTS "${password_temp_collision_sealed}")
  message(FATAL_ERROR "seal-file-password created output when temporary output existed")
endif()
...
run_cli_failure("Output temporary file already exists\n" open-file-password --in "${password_sealed}" --out "${password_temp_collision_opened}" --password-file "${password_file}")
if(EXISTS "${password_temp_collision_opened}")
  message(FATAL_ERROR "open-file-password created output when temporary output existed")
endif()
