...
set(wrong_aad_opened_file "${SECUREKIT_CLI_WORK_DIR}/securekit-installed-cli-wrong-aad-opened.txt")
set(verify_output_probe "${SECUREKIT_CLI_WORK_DIR}/securekit-installed-cli-verify-output-probe.txt")
...
set(password_verify_output_probe "${SECUREKIT_CLI_WORK_DIR}/securekit-installed-cli-password-verify-output-probe.txt")
...
set(packet_wrong_aad_opened_file "${SECUREKIT_CLI_WORK_DIR}/securekit-installed-cli-packet-wrong-aad.txt")
...
file(REMOVE "${wrong_aad_opened_file}")
...
run_cli_failure("File authentication failed\n" open-file --key-file "${key_file}" --out "${wrong_aad_opened_file}" --aad-text record:v2 --in "${sealed_file}")
assert_file_absent("${wrong_aad_opened_file}")
run_cli_no_stdout(verify-file --key-file "${key_file}" --aad-text record:v1 --in "${sealed_file}")
run_cli_failure("File authentication failed\n" verify-file --key-file "${key_file}" --aad-text record:v2 --in "${sealed_file}")
run_cli_failure("unsupported file option: --out\n" verify-file --key-file "${key_file}" --aad-text record:v1 --in "${sealed_file}" --out "${verify_output_probe}")
...
run_cli_stdin_no_stdout("${pipe_sealed_file}" verify-file --in - --key-file "${key_file}" --aad-text record:v1)
...
assert_file_absent("${password_wrong_opened_file}")
run_cli_no_stdout(verify-file-password --in "${password_sealed_file}" --password-file "${password_file}" --aad-text record:v1)
run_cli_failure("File authentication failed\n" verify-file-password --in "${password_sealed_file}" --password-file "${wrong_password_file}" --aad-text record:v1)
run_cli_failure("unsupported password file option: --out\n" verify-file-password --in "${password_sealed_file}" --password-file "${password_file}" --aad-text record:v1 --out "${password_verify_output_probe}")
...
run_cli_stdin_no_stdout("${password_pipe_sealed_file}" verify-file-password --in - --password-file "${password_file}" --aad-text record:v1)
...
run_cli_failure("AEAD authentication failed\n" decrypt --packet-file "${packet_file}" --out "${packet_wrong_aad_opened_file}" --key-file "${key_file}" --aad-text record:v2)
