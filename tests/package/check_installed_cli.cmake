...
run_cli_failure("Output temporary file already exists\n" seal-file --in "${plain_file}" --out "${temp_collision_sealed_file}" --key-file "${key_file}" --aad-text record:v1)
if(EXISTS "${temp_collision_sealed_file}")
  message(FATAL_ERROR "installed CLI seal-file created output when temporary output existed")
endif()
...
run_cli_failure("Output temporary file already exists\n" open-file --in "${sealed_file}" --out "${temp_collision_opened_file}" --key-file "${key_file}" --aad-text record:v1)
if(EXISTS "${temp_collision_opened_file}")
  message(FATAL_ERROR "installed CLI open-file created output when temporary output existed")
endif()
