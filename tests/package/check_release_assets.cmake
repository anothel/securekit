...
set(_securekit_source_zip_artifact "${_securekit_artifact_dir}/${_securekit_artifact_prefix}source.zip")
set(_securekit_source_tgz_artifact "${_securekit_artifact_dir}/${_securekit_artifact_prefix}source.tar.gz")
...
set(_securekit_has_binary_zip OFF)
set(_securekit_has_binary_tgz OFF)
...
foreach(_securekit_artifact IN LISTS _securekit_artifacts)
  ...
  elseif(NOT _securekit_source_marker_at EQUAL -1)
    ...
    if(_securekit_artifact_name MATCHES "\\.zip$")
      set(_securekit_has_binary_zip ON)
    elseif(_securekit_artifact_name MATCHES "\\.tar\\.gz$")
      set(_securekit_has_binary_tgz ON)
    endif()
  endif()
endforeach()
...
if(NOT _securekit_has_binary_zip)
  message(FATAL_ERROR "No binary ZIP package artifact found for ${SECUREKIT_PROJECT_VERSION}")
endif()
if(NOT _securekit_has_binary_tgz)
  message(FATAL_ERROR "No binary TGZ package artifact found for ${SECUREKIT_PROJECT_VERSION}")
endif()
